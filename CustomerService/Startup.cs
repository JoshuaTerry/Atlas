...
namespace DriveCentric.CustomerServiceService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBaseService<DriveCentric.Core.Models.CustomerService>, BaseService<DriveCentric.Core.Models.CustomerService>>();
            ...
            services.AddSwaggerGen(c => c.SwaggerDoc("v1", new Info { Title = "Atlas - CustomerService Service", Version = "v1" }));
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Atlas - CustomerService - V1"));
